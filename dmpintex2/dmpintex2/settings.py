"""
Django settings for dmpintex2 project.
...
SECRET_KEY = '&q(oqyc)3idypkvn+nr%n(7u9fwc%qyi)67^zlh5%&dk9!v#0#'
...
WSGI_APPLICATION = 'dmpintex2.wsgi.application'
